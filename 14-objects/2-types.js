...
var personObj2 = new Person(7, 'Ram');
console.log(personObj2.height);
console.log(personObj2.getHeightInMetres());
console.log(personObj2.getName());

// here if i call the getComplexion() from the instances
console.log('calling get complexion method');
...
Person.prototype.complexion = 'Brown';
